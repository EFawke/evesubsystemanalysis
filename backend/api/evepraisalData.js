...
const insertIntoPrices = (data) => {
    ...
    // client.query(`INSERT INTO evepraisal_prices (itemID, name, amarr_buy, amarr_sell, amarr_buy_orders, amarr_buy_volume, amarr_sell_orders, amarr_sell_volume, jita_buy, jita_sell, jita_buy_orders, jita_buy_volume, jita_sell_orders, jita_sell_volume) VALUES (${itemId}, '${name}', '${amarrBuy}', '${amarrSell}', ${amarrBuyOrdersCount}, ${amarrBuyVolume}, ${amarrSellOrdersCount}, ${amarrSellVolume}, '${jitaBuy}', '${jitaSell}', ${jitaBuyOrdersCount}, ${jitaBuyVolume}, ${jitaSellOrdersCount}, ${jitaSellVolume})`)
    //     .catch(err => {
